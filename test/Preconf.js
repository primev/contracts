...
describe("Preconf", function () {
  ...
  describe("Deployment", function () {
    it("Should deploy the smart contract and store info", async function () {
      ...
      const address = (await preconf.recoverAddress("0xkartik", 2, 2, signature))[0];
      expect(address).to.equal("0x3533d88fC84531a6542C8c09b27e7D292f6537B5");
      
      const txn = await preconf.storeBid("0xkartik", 2, 2, signature);
      await txn.wait();
